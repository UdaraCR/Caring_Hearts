...
<html lang="en">
   <head>
      ...
      <title>Caregiver Task Management System || Manage Employee</title>
...
{               ?> 
                                          <tr>
                                             ...
                                             <td><a href="edit-employee.php?editid=<?php echo htmlentities ($row->eid);?>" class="btn btn-primary">Edit</a>
                                              <a href="manage-employee.php?delid=<?php echo ($row->eid);?>" onclick="return confirm('Do you really want to Delete ?');" class="btn btn-danger">Delete</a></td>
                                          </tr><?php $cnt=$cnt+1;}} ?>
                                       </tbody>
                                    </table>
                                 </div>
