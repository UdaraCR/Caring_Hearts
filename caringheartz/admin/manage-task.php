...
//lets add history
    insertTaskHistory($rid, $_SESSION['etmsaid'], 'admin', 'deleted task');
...
<html lang="en">
   <head>
      ...
      <title>Caregiver Task Management System || Manage Task</title>
...
{               ?> 
                                          <tr>
                                             ...
                                             <td><a href="edit-task.php?editid=<?php echo htmlentities ($row->tid);?>" class="btn btn-primary">Edit</a>
                                                 <a href="manage-task.php?delid=<?php echo ($row->tid);?>" onclick="return confirm('Do you really want to Delete ?');" class="btn btn-danger">Delete</a>
                                                 <a href="task-history.php?task_id=<?php echo ($row->tid);?>"  class="btn btn-info mt-1">View History</a>
