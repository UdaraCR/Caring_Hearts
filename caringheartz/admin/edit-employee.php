...
if (strlen($_SESSION['etmsaid']==0)) {
 ...
 $desc=$_POST['desc'];
 $eid=$_GET['editid'];
$sql="update tblemployee set DepartmentID=:deptname,EmpId=:empid,EmpName=:empname,EmpEmail=:empemail,EmpContactNumber=:empcontno,Designation=:designation,EmpDateofbirth=:empdob,EmpAddress=:empadd,EmpDateofjoining=:empdoj,Description=:desc where ID=:eid";
...
<html lang="en">
   <head>
      <title>Caregiver Task Management System || Update Employee</title>
