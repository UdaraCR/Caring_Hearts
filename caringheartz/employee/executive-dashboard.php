...
// chart1 data
    $completionRatesData = getCompletionRatesData($dates, $empId);
    $averageCompletionTimeData = getAverageCompletionTimeData($dates, $empId);
    $jsData = [
        'completionRatesData' => $completionRatesData,
        'averageCompletionTimeData' => $averageCompletionTimeData
    ];
//chart2 data
    $newTasksData = getTasksByStatus($dates, 'new', $empId);
    $inProgressTasksData = getTasksByStatus($dates, 'inprogress', $empId);
    $completedTasksData = getTasksByStatus($dates, 'completed', $empId);
    $overdueTasksData = getOverdueTasks($dates, $empId);
